...
impl From<Sprite> for u8 {
    fn from(value: Sprite) -> Self {
        match value {
            Sprite::Things(Things::Transfer) => 0,
            Sprite::Door(Door::Gold) => 1,
            Sprite::Collectible(Collectible::GoldKey) => 2,
            Sprite::Collectible(Collectible::Sword) => 3,
            Sprite::Door(Door::Silver) => 4,
            Sprite::Collectible(Collectible::SilverKey) => 5,
            Sprite::Collectible(Collectible::PortalStone) => 6,
            Sprite::Collectible(Collectible::Gem) => 7,
            Sprite::Collectible(Collectible::Treasure) => 8,
            Sprite::Gear(Gear::Hammer) => 9,
            Sprite::Door(Door::Boulder) => 10,
            Sprite::Gear(Gear::Boots) => 11,
            Sprite::Gear(Gear::Compass) => 12,
            Sprite::Things(Things::CompassWall) => 13,
            Sprite::Things(Things::Warp) => 15,
            Sprite::Door(Door::Blue) => 22,
            Sprite::Collectible(Collectible::BlueKey) => 23,
            Sprite::WindRoute => 25,
            Sprite::Save => 44,
            Sprite::Gear(Gear::GemSword) => 51,
            Sprite::Gear(Gear::Spectacles) => 52,
            Sprite::Door(Door::Green) => 54,
            Sprite::Collectible(Collectible::GreenKey) => 55,
            Sprite::Collectible(Collectible::GoldSword) => 56,
            Sprite::Collectible(Collectible::Heart) => 57,
            Sprite::Gear(Gear::LavaCharm) => 59,
            Sprite::Door(Door::Red) => 61,
            Sprite::Collectible(Collectible::RedKey) => 62,
            Sprite::Collectible(Collectible::ShrineKey) => 63,
            Sprite::Collectible(Collectible::Shield) => 64,
            Sprite::Gear(Gear::GemShield) => 65,
            Sprite::Gear(Gear::SkeletonKey) => 67,
            Sprite::Collectible(Collectible::Stopwatch) => 68,
            Sprite::Gear(Gear::WindRing) => 72,
            Sprite::Enemy(Enemy::Basilisk) => 108,
            Sprite::Enemy(Enemy::Bat) => 109,
            Sprite::Enemy(Enemy::YBat) => 110,
            Sprite::Enemy(Enemy::CloneW) => 112,
            Sprite::Enemy(Enemy::CloneP) => 113,
            Sprite::Enemy(Enemy::GDragon) => 114,
            Sprite::Enemy(Enemy::Fireball) => 115,
            Sprite::Enemy(Enemy::PFireball) => 116,
            Sprite::Enemy(Enemy::Gargoyle) => 117,
            Sprite::Enemy(Enemy::Ghost) => 118,
            Sprite::Enemy(Enemy::Guard) => 119,
            Sprite::Enemy(Enemy::SGuard) => 120,
            Sprite::Enemy(Enemy::Glitch) => 121,
            Sprite::Enemy(Enemy::Pirate) => 122,
            Sprite::Enemy(Enemy::Rat) => 124,
            Sprite::Enemy(Enemy::GRat) => 125,
            Sprite::Enemy(Enemy::Skeleton) => 126,
            Sprite::Enemy(Enemy::DSkeleton) => 127,
            Sprite::Enemy(Enemy::GSkeleton) => 129,
            Sprite::Enemy(Enemy::BSlime) => 130,
            Sprite::Enemy(Enemy::PSlime) => 131,
            Sprite::Enemy(Enemy::GSlime) => 133,
            Sprite::Enemy(Enemy::RSlime) => 134,
            Sprite::Enemy(Enemy::YSlime) => 135,
            Sprite::Enemy(Enemy::Spider) => 137,
            Sprite::Enemy(Enemy::WSpider) => 138,
            Sprite::Enemy(Enemy::Whelp) => 139,
            Sprite::Enemy(Enemy::BWhelp) => 141,
            Sprite::Enemy(Enemy::GWhelp) => 142,
            Sprite::Enemy(Enemy::Witch) => 143,
            Sprite::Enemy(Enemy::FairyR) => 148,
            Sprite::Enemy(Enemy::FairyG) => 149,
            Sprite::Enemy(Enemy::FairyB) => 150,
            Sprite::Collectible(Collectible::GemHeart) => 152,
            Sprite::Enemy(Enemy::Rabbit) => 160,
            Sprite::Enemy(Enemy::GWitch) => 191,
            Sprite::Things(Things::NGPMountain) => 195,
            Sprite::Things(Things::NGMountain) => 196,
            Sprite::Things(Things::NGPTransfer) => 197,
            Sprite::Things(Things::NGPBoulder) => 198,
            Sprite::Collectible(Collectible::UnderworldKey) => 199,
            Sprite::Things(Things::NGPWall) => 200,
            Sprite::Door(Door::Underworld) => 201,
            Sprite::Things(Things::UnderworldKeyhole) => 208,
            Sprite::Gear(Gear::RedShield) => 209,
            Sprite::Gear(Gear::RedSword) => 210,
            Sprite::Collectible(Collectible::PossumCoin) => 213,
            Sprite::Door(Door::Teal) => 247,
            Sprite::Collectible(Collectible::TealKey) => 248,
